...
let BitcoinWallet = class BitcoinWallet {
};
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.bitcoinWallets),
    __metadata("design:type", user_entity_1.User)
], BitcoinWallet.prototype, "user", void 0);
exports.BitcoinWallet = BitcoinWallet = __decorate([
    (0, typeorm_1.Entity)('bitcoin_wallets')
], BitcoinWallet);
